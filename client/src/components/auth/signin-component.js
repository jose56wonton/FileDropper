            ...
            <div className="ui form">
              <div className="field">
                ...
                <div className="ui left icon input">
                  <input type="email" placeholder="asdf@gmail.com" onChange={props.handleEmailChange} value={props.email} />
              ...
              <div className="field">
                ...
                <div className="ui left icon input">
                  <input className="u-full-width" type="password" placeholder="********" onChange={props.handlePasswordChange} value={props.password} />
